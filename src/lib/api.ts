  ...
  try {
    ...
    const messages = data.messages.map((msg: any) => {
      ...
      return {
        ...
        // Try all possible content fields, with rawMessage taking precedence
        content: msg.rawMessage || msg.originalContent || msg.Body || msg.body || msg.content || msg.message || msg.text || '',
